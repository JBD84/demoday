...
const MERN = () => {
    return (
        ...
        <a href="https://www.mongodb.com/" target="_blank" rel="noreferrer" >
            <span className="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="left" title="https://www.mongodb.com/"><img src="mongodb.png" alt='MongoDB Icon' height="24"></img> MongoDB
            </span>
        </a>
         <a href="https://expressjs.com/" target="_blank" rel="noreferrer" >
            <span className="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="left" title="https://expressjs.com/"><img src="express.png" alt='Express Icon' height="16"></img> Express
            </span> 
        </a> 
         <a href="https://reactjs.org" target="_blank" rel="noreferrer" >
            <span className="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="left" title="https://reactjs.org"><img src="react.png" alt='React Icon' height="16"></img> React
            </span> 
        </a> 
         <a href="https://nodejs.org/" target="_blank" rel="noreferrer" >
            <span className="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="left" title="https://nodejs.org/"><img src="nodejs.png" alt='NodeJS Icon' height="16"></img> Node.js
            </span> 
        </a> 
        </tr>
        </table>           
...
const about = <> 
    ...
    Bootswatch theme's <a href="https://bootswatch.com/spacelab" target="_blank" rel="noreferrer" className="btn btn-warning" alt='SpaceLab Icon'>Spacelab</a>
    <hr/>
